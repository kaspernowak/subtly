...
class TranslationHistory(SQLModel, table=True):
    ...
    status: str = Field(max_length=20)  # success, failed, in_progress
...
class User(UserBase, table=True):
    ...
    # Relationships
    subscription: UserSubscription | None = Relationship(back_populates="user")
    translations: list[TranslationHistory] = Relationship(back_populates="user")
